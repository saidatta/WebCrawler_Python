...
directory = 'C:/Users/Venkata/Desktop/Crawler_Manga' # Change to whatever directory you want to save everything.
...
def downloadChapter(url):
    ...
    urlChap = url
    print urlChap, " Inside downloadChap"
    ...
    #print soupChap, " Document of the chapter."
